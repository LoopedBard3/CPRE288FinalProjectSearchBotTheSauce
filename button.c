...
uint8_t button_getButton() {
    ...
    //Check each button if its pressed from highest to lowest and return the button
    if(~GPIO_PORTE_DATA_R & 0b00100000){    //Button 6
        return 6;
    }else if(~GPIO_PORTE_DATA_R & 0b00010000){ //Button 5
        return 5;
    }else if(~GPIO_PORTE_DATA_R & 0b00001000){  //Button 4
        return 4;
    }else if(~GPIO_PORTE_DATA_R & 0b00000100){ //Button 3
        return 3;
    }else if(~GPIO_PORTE_DATA_R & 0b00000010){  //Button 2
        return 2;
    }else if(~GPIO_PORTE_DATA_R & 0b00000001){  //Button 1
        return 1;
    }
	
	return 0; //No buttons are pressed
}
